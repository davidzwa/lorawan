...
//                 multicastRelaying);
  ...
  //LogComponentEnable ("EndDeviceLorawanMac", (LogLevel)(LOG_PREFIX_TIME | LOG_LEVEL_ALL));
  //LogComponentEnable ("GatewayLorawanMac", (LogLevel)(LOG_PREFIX_TIME | LOG_LEVEL_ALL));
  // LogComponentEnable ("LogicalLoraChannelHelper", LOG_LEVEL_ALL);
  // LogComponentEnable ("LogicalLoraChannel", LOG_LEVEL_ALL);
  // LogComponentEnable ("LoraHelper", LOG_LEVEL_ALL);
  // LogComponentEnable ("LoraPhyHelper", (LogLevel)(LOG_PREFIX_TIME | LOG_LEVEL_ALL));
  // LogComponentEnable ("LorawanMacHelper", (LogLevel)(LOG_PREFIX_TIME | LOG_LEVEL_ALL));
